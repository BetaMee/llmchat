...
echo "2. 准备训练数据: python3 src/data_processor.py --input data/figma-records.jsonl --output data/train.json"
echo "3. 运行训练: python3 src/train.py"
echo "4. 测试推理: python3 src/inference.py --model_path ./outputs/final_model --mode test"
echo ""
